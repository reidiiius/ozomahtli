...
Elapida.worker.stonewall = function() {
  ...
  process.stdout.write('returned: ' + rope);
...
Elapida.worker.tutorial = function() {
  ...
  process.stdout.write('returned: ' + wire);
