...
Panopolis.stringTuner = function(sym, qp) {
  print('\t' + Panopolis[sym].fn(qp));
  print('\t' + Panopolis[sym].cn(qp));
  print('\t' + Panopolis[sym].gn(qp));
  print('\t' + Panopolis[sym].dn(qp));
  print('\t' + Panopolis[sym].an(qp));
  print('\t' + Panopolis[sym].en(qp));
  print('\t' + Panopolis[sym].bn(qp));
  print('\t' + Panopolis[sym].fk(qp));
  print('\t' + Panopolis[sym].ck(qp));
  print('\t' + Panopolis[sym].gk(qp));
  print('\t' + Panopolis[sym].dk(qp));
  print('\t' + Panopolis[sym].ak(qp));
};
